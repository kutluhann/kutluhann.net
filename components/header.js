  ...
  return (
    <header className="wiggle bg-primary text-white">
      <div className="container py-20 px-6 text-center relative flex justify-center flex-col items-center">
        <Link href="/">
          <h1 className="title text-3">{name}</h1>
          <p className="text-6">{desc}</p>
        </Link>
        <div className="absolute inset-x-0 bottom-0 flex justify-center items-center">
          <div className="flex justify-center items-center flex-row h-12 bg-white text-gray-500 p-2 rounded-10 shadow relative top-6">
            <a href={twitterLink} target="_blank" aria-label="twitter" className="cursor-pointer mx-2 hover:text-twitter hover:rotate transition-rotate" rel="noreferrer">
            ...
            <a href={instagramLink} target="_blank" aria-label="instagram" className="cursor-pointer mx-2 hover:text-instagram hover:rotate transition-rotate" rel="noreferrer">
              <svg className="h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <a href={githubLink} target="_blank" aria-label="github" className="cursor-pointer mx-2 hover:text-github hover:rotate transition-rotate" rel="noreferrer">
              <svg className="h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
